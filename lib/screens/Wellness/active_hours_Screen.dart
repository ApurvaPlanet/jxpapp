...
class ActiveHoursScreen extends StatefulWidget {
  const ActiveHoursScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Column(
            children: [
              const SubAppBar(pageTitle: 'Active Hours', showBackBtn: true),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: HistoryTitleWidget(
                  title: "Active Hours History",
                  items: [
                    IconButton(
                      icon: Icon(Icons.add),
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AddRecordPopup(module: 'activehours', title: 'Record Active Hours', inputText1: 'Active Hours', inputText2: 'Awake Time');
                          },
                        );
                      },
                    ),
              ...
              Expanded(child: ListWidget(wellnessData: filteredData ?? [], module: 'activehours',)),
            ],
          ),
